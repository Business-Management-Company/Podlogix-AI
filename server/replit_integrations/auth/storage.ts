...
export interface IAuthStorage {
  ...
  updateUserProfile(userId: string, data: { firstName?: string; lastName?: string; profileImageUrl?: string; phone?: string; zipCode?: string; bio?: string; podchaserPersonId?: string | null }): Promise<User | undefined>;
...
class AuthStorage implements IAuthStorage {
  ...
  async updateUserProfile(userId: string, data: { firstName?: string; lastName?: string; profileImageUrl?: string; phone?: string; zipCode?: string; bio?: string; podchaserPersonId?: string | null }): Promise<User | undefined> {
    const [user] = await db
      .update(users)
