...
const articles: Article[] = [
  // Get Started
  {
    ...
    content: [
      ...
      "• Facet — turns raw conversations into clear, compelling content.",
  ...
  },
  {
    ...
    content: [
      ...
      "• Refine this show — the red button sends the whole recording to Facet, where the polish happens.",
      "Everything you make here lands in Media Storage automatically.",
    ],
  },
  {
    id: "facet", title: "Facet",
    description: "One button that polishes a whole recording — for real.",
    category: "Studio", icon: <Sparkles className="h-4 w-4" />,
    tags: ["facet", "refiner", "refine", "polish", "audio", "pipeline"],
    content: [
      "Facet turns raw conversations into clear, compelling content. Find it in the nav, right under Live Studio.",
      "How to use it:",
      "1. Pick a recent recording on the Facet page, or choose anything in Media Storage and press 'Open in Facet'.",
